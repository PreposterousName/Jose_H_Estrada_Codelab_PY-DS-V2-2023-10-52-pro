...
cat = nombre + " " + str(edad) + str(estatura) + str(estudiante)
...
# En Python 3 tipo de dato int no tiene limite
# En Python 3 tipo de dato int no limite  de 1.8 X 10308
...
print(cat)
print("En Python 3 tipo de dato int no tiene limite")
print("En Python 3 tipo de dato int no limite  de 1.8 X 10308")
print(s)